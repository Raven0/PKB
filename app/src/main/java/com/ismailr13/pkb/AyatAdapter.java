...
public class AyatAdapter extends BaseAdapter {
    ...
    public AyatAdapter(Activity activity, ArrayList listItem){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null){
            ...
            view = inflater.inflate(R.layout.item_ayat, null);
            holder.txtNumber = (TextView)view.findViewById(R.id.txt_item_number);
            holder.txtContent = (TextView)view.findViewById(R.id.txt_item_content);
            view.setTag(holder);
        }else{
            holder = (ViewHolder)view.getTag();
        }

        AyatModel law = (AyatModel) getItem(position);
        holder.txtNumber.setText(law.getNumber());
        holder.txtContent.setText(law.getContent());
        return view;
    }

    static class ViewHolder{
        TextView txtNumber, txtContent;
    }
}
