...
public class BabAdapter extends BaseAdapter {
    // params
    ArrayList listItem;
    Activity activity;

    public BabAdapter(Activity activity, ArrayList listItem){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null){
            ...
            view = inflater.inflate(R.layout.item_bab, null);
        ...
        BabModel law = (BabModel) getItem(position);
